            ...
            <div className="relative flex h-16 justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  ...
                  <a
                    href="#"
                    className="inline-flex items-center border-b-2 border-teal-300 px-1 pt-1 text-sm font-medium text-gray-900"
                  >
                    Dashboard
                  </a>
                  <a
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {!userId && <>
                  <SignUpButton>
              <button className="inline-flex h-10 animate-shimmer items-center justify-center rounded-md border border-teal-300 bg-teal-300 px-4 font-medium text-white transition duration-300 ease-out hover:scale-110 hover:border-teal-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-white">
          Sign Up
        </button>
        </SignUpButton></>}
                </Menu>
